...
function assetsFor(page,prefix='../') {
 ...
 if(!page.formPage&&page.type!=='seller'){styles.push(prefix+'shared/partner-marquee.css?v=20260922-even-spacing');scripts.push(prefix+'shared/partner-marquee.js?v=20260916-continuous');}
