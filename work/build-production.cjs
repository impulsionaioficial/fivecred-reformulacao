...
for(const page of manifest){for(const file of ['index.html','politica-de-privacidade.html','termos-de-uso.html',...(page.aliases||[])])pages.push(page.slug+'/'+file);if(page.type==='seller')for(const file of ['index.html','politica-de-privacidade.html','termos-de-uso.html'])pages.push(page.slug+'/dist/'+file);}
