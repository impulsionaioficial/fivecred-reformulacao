...
const messages={
 ...
 'bolsa-fivecred':['Veja as possibilidades para você.','Simule de R$ 100 a R$ 750, em 12 parcelas de até R$ 159. Sujeito à análise.','Simule aqui','Crédito para quem recebe Bolsa Família'],
 ...
 'imovel-fivecred':['Dê o primeiro passo com seu imóvel.','Crédito a partir de R$ 50 mil. Conte sobre você e o imóvel que pretende usar como garantia.','Simule aqui','Crédito com garantia de imóvel'],
