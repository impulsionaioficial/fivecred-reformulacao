...
function BuyerForm({placement}: {placement:string}) {
  ...
  return <div className="cf-card cf-buyer"><FormHeader title={isCta?'Falar com um Consultor de Crédito':'Ver Cartas Disponíveis'} description={isCta?'Seg a Sex, 8h às 18h · Av. Presidente Juscelino Kubitschek, 1327, São Paulo – SP':'Preencha e um especialista entra em contato hoje'}/>
